...
const allWordsForGameTypeOrWrite = {
    ...
    formulas0: [
        {					
            id	:	1	,		
            eng	:	"One"	,
            ru	:	"Напишите  английскую  цифру     Один"	
            }	,				
            {					
            id	:	2	,		
            eng	:	"Two"	,
            ru	:	"Напишите  английскую  цифру     Два"	
            }	,				
            {					
            id	:	3	,		
            eng	:	"Three"	,
            ru	:	"Напишите  английскую  цифру     Три"	
            }	,			
            {					
            id	:	4	,		
            eng	:	"Four"	,
            ru	:	"Напишите  английскую  цифру     Четыре"	
            }	,				
            {					
            id	:	5	,		
            eng	:	"Five"	,
            ru	:	"Напишите  английскую  цифру     Пять"	
            }	,				
            {					
            id	:	6	,		
            eng	:	"Six"	,
            ru	:	"Напишите  английскую  цифру     Шесть"	
            }	,				
            {					
            id	:	7	,		
            eng	:	"Seven"	,
            ru	:	"Напишите  английскую  цифру     Семь"	
            }	,				
            {					
            id	:	8	,		
            eng	:	"Eight"	,
            ru	:	"Напишите  английскую  цифру     Восемь"	
            }	,				
            {					
            id	:	9	,		
            eng	:	"Nine"	,
            ru	:	"Напишите  английскую  цифру     Девять"	
            }	,				
            {					
            id	:	10	,		
            eng	:	"Eleven"	,
            ru	:	"Напишите  как по-английски     Одинадцать"	
            }	,				
            {					
            id	:	11	,		
            eng	:	"Twelve"	,
            ru	:	"Напишите  как по-английски     Двенадцать"	
            }	,				
            {					
            id	:	12	,		
            eng	:	"Twenty"	,
            ru	:	"Напишите  как по-английски     Двадцать"	
            }	,		
            {					
            id	:	13	,		
            eng	:	"Thirty"	,
            ru	:	"Напишите  как по-английски     Тридцать"	
            }	,		
            {					
            id	:	14	,		
            eng	:	"Hundred"	,
            ru	:	"Напишите  как по-английски будет Сто"	
            }	,				
    ],
    questions0: [
        {					
